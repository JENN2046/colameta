# ColaMeta Project Master Taskbook v1.1 Candidate 1
...
master_taskbook:
  ...
  candidate_lineage:
    ...
    candidate_change_scope:
      - mechanically_reproducible_canonical_payload_and_freeze_hash
      - conditional_review_decision_transition_fields
      - conditional_gate_event_transition_fields
...
PROJECT_MASTER_TASKBOOK.v1.1-candidate.1.md draft until it is ready for
...
3. Review the new v1.1-candidate.1 contract corrections, raw snapshot hash, and canonical freeze hash.

...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Update the docs, but you must not modify any files.",
        "Update the docs; we cannot change the project.",
        "Update the docs. You must not edit any files.",
        "Update the docs, and please you must not patch the working tree.",
        "Update the docs to explain routing and you must not modify any files.",
        "Update the docs to explain routing and we cannot change the project.",
        "Update the docs, but you must not write to any files.",
        "Update the docs, and we must not make any changes.",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Update the docs to explain why you must not modify any files.",
        "Update the docs to describe workflows where we cannot change the project.",
        "Update the docs, but you must not modify any test files.",
        "Update the docs; we cannot change the project configuration.",

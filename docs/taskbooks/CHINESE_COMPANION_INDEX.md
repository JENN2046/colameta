...
| `docs/taskbooks/versions/stage-06/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_06_VERSIONS.md` | `docs/taskbooks/versions/stage-06/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_06_VERSIONS.zh-CN.md` | `companion_draft` | Stage 6 Version set freeze packet draft 中文 companion 已生成，只是审查材料，不授权实现、commit、push、ReviewDecision、GateEvent 或 delivery state。 |

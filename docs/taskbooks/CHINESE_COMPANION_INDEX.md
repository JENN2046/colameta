...
| `docs/taskbooks/versions/stage-02/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_02_VERSIONS.md` | `docs/taskbooks/versions/stage-02/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_02_VERSIONS.zh-CN.md` | `companion_draft` | Stage 2 Version set freeze packet 中文 companion 已生成，仍是 packet 草稿，不授权 freeze、实现、registry mutation、commit 或 push。 |

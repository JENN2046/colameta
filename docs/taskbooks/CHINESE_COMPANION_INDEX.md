...
| `docs/taskbooks/stages/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_0_6.md` | `docs/taskbooks/stages/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_0_6.zh-CN.md` | `companion_draft` | Stage 0-6 Stage set freeze confirmation record 中文 companion 已生成，只记录精确 hash 的 freeze_candidate 审查状态，不授权实现、commit 或 push。 |
...
| `docs/taskbooks/versions/stage-03/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_03_VERSIONS.md` | `docs/taskbooks/versions/stage-03/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_03_VERSIONS.zh-CN.md` | `companion_draft` | Stage 3 Version set freeze confirmation record 中文 companion 已生成，只记录精确 hash 的 freeze_candidate 审查状态，不授权实现、plan mutation、commit 或 push。 |
...
| `docs/taskbooks/versions/stage-04/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_04_VERSIONS.md` | `docs/taskbooks/versions/stage-04/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_04_VERSIONS.zh-CN.md` | `companion_draft` | Stage 4 Version set freeze confirmation record 中文 companion 已生成，只记录精确 hash 的 freeze_candidate 审查状态，不授权实现、local execution、review acceptance、commit 或 push。 |
...
| `docs/taskbooks/versions/stage-05/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_05_VERSIONS.md` | `docs/taskbooks/versions/stage-05/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_05_VERSIONS.zh-CN.md` | `companion_draft` | Stage 5 Version set freeze confirmation record 中文 companion 已生成，只记录精确 hash 的 freeze_candidate 审查状态，不授权实现、commit、push、review acceptance 或 delivery state。 |
| `docs/taskbooks/versions/stage-06/VERSION_STAGE_06_V6_1_REVIEW_FEEDBACK_SCHEMA_V1.md` | `docs/taskbooks/versions/stage-06/zh-CN/VERSION_STAGE_06_V6_1_REVIEW_FEEDBACK_SCHEMA_V1.zh-CN.md` | `companion_draft` | Stage 6 / v6.1 中文 companion 已生成，尚未授权实现、ReviewDecision creation、GateEvent emission、commit 或 push。 |
| `docs/taskbooks/versions/stage-06/VERSION_STAGE_06_V6_2_REVIEW_FEEDBACK_VALIDATOR_V1.md` | `docs/taskbooks/versions/stage-06/zh-CN/VERSION_STAGE_06_V6_2_REVIEW_FEEDBACK_VALIDATOR_V1.zh-CN.md` | `companion_draft` | Stage 6 / v6.2 中文 companion 已生成，尚未授权实现、CommanderDecisionRequest generation、commit 或 push。 |
| `docs/taskbooks/versions/stage-06/VERSION_STAGE_06_V6_3_REVIEW_FEEDBACK_PREVIEW_V1.md` | `docs/taskbooks/versions/stage-06/zh-CN/VERSION_STAGE_06_V6_3_REVIEW_FEEDBACK_PREVIEW_V1.zh-CN.md` | `companion_draft` | Stage 6 / v6.3 中文 companion 已生成，尚未授权实现、request creation、GateEvent emission、commit 或 push。 |
| `docs/taskbooks/versions/stage-06/VERSION_STAGE_06_V6_4_REVIEW_FEEDBACK_CLASSIFICATION_AND_DECISION_REQUEST_V1.md` | `docs/taskbooks/versions/stage-06/zh-CN/VERSION_STAGE_06_V6_4_REVIEW_FEEDBACK_CLASSIFICATION_AND_DECISION_REQUEST_V1.zh-CN.md` | `companion_draft` | Stage 6 / v6.4 中文 companion 已生成，尚未授权实现、Commander authorization、GateEvent emission、commit 或 push。 |
| `docs/taskbooks/versions/stage-06/VERSION_STAGE_06_V6_5_REVIEW_DECISION_ADAPTER_V1.md` | `docs/taskbooks/versions/stage-06/zh-CN/VERSION_STAGE_06_V6_5_REVIEW_DECISION_ADAPTER_V1.zh-CN.md` | `companion_draft` | Stage 6 / v6.5 中文 companion 已生成，尚未授权实现、ReviewDecision persistence、GateEvent emission、commit 或 push。 |
| `docs/taskbooks/versions/stage-06/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_06_VERSIONS.md` | `docs/taskbooks/versions/stage-06/zh-CN/FREEZE_CANDIDATE_REVIEW_PACKET_STAGE_06_VERSIONS.zh-CN.md` | `companion_draft` | Stage 6 Version set freeze confirmation record 中文 companion 已生成，只记录精确 hash 的 freeze_candidate 审查状态，不授权实现、commit、push、ReviewDecision、GateEvent 或 delivery state。 |

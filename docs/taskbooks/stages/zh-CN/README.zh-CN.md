...
chinese_companion:
  ...
  source_sha256: 70d45584212c6ee817c5f61da32d371590e6dcddc1cce634f2f31fa15b70fed9
...
`Stage Taskbook` = 阶段任务书。它把 Master Taskbook 的最高目标拆成一个阶段
内可审查、可引用、可继续细分的交付边界。

阶段任务书只拥有“阶段声明”和“阶段边界”，不拥有运行事实、不拥有验收状态、
不替代 Version Execution Taskbook，也不授权 executor 派发。

## 2. MVP 阶段清单

| 阶段 | 中文名称 | 中文 companion |
| --- | --- | --- |
| Stage 0 | 基线收束与执行状态清晰化 | `STAGE_00_BASELINE_CLOSEOUT.zh-CN.md` |
| Stage 1 | 主任务书锚定 | `STAGE_01_MASTER_TASKBOOK_ANCHORING.zh-CN.md` |
| Stage 2 | 阶段任务书管理 | `STAGE_02_STAGE_TASKBOOK_MANAGEMENT.zh-CN.md` |
| Stage 3 | 外部任务书导入协议 | `STAGE_03_EXTERNAL_TASKBOOK_IMPORT.zh-CN.md` |
| Stage 4 | 有边界执行与证据 | `STAGE_04_BOUNDED_EXECUTION_AND_EVIDENCE.zh-CN.md` |
